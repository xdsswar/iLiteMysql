...
public class Single {
    ...
    static {
        ...
        rt.addShutdownHook(new Thread(new Single.ShutdownHook()));
    }
     ...
     */
    public static void acquireLock(String id) throws LockedException {
        acquireLock(id, null);
    }
     ...
     *             taken in the user-space.
     */
    public static void acquireLock(String id, NotifyHandler notifyHandler)
        ...
        try {
            ...
            server = new Server(id, notifyHandler);
    ...
    public static String sendMessage(String id, String message) {
        ...
        if (port > 0) {
            ...
            try {
                ...
                Notify.write(message, outputStream);
                response = Notify.read(inputStream);
            } catch (Throwable t) {
                t.printStackTrace();
            } finally {
    ...
    /**
     * This one performs a cross-JVM lock on all Single instances. Calling this
     * lock causes the acquisition of an exclusive extra-JVM access to Single
    ...
    /**
     * Release a previously acquired extra-JVM Single lock.
     */
