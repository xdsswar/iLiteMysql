 ...
 * @author XDSSWAR
 */
public class DecimalFormatter extends TextFormatter<Number> {
    private static final DecimalFormat format = new DecimalFormat("#.0;-#.0");

    public DecimalFormatter(int minDecimals, int maxDecimals) {
        super(getStringConverter(minDecimals, maxDecimals), 0, getUnaryOperator(maxDecimals, true,-1));
    }

    public DecimalFormatter(int minDecimals, int maxDecimals, boolean allowsNegative) {
        super(getStringConverter(minDecimals, maxDecimals), 0, getUnaryOperator(maxDecimals, allowsNegative,-1));
    }

    public DecimalFormatter(int minDecimals, int maxDecimals, boolean allowsNegative , int maxNoOfDigitsBeforeDecimal) {
    ...
    private static UnaryOperator<TextFormatter.Change> getUnaryOperator(int maxDecimals,
